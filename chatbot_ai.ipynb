{
 "cells": [
  ...
  },
  {
   ...
   "source": [
    "# 🧹 Step 3: Clean + Keep useful columns"
   ]
  },
  {
   "cell_type": "code",
   ...
   "source": [
    ...
    "\n",
    "df = df.head(5000)\n",
    "print(\"✅ Data cleaned and trimmed:\", df.shape)"
   ]
  },
  {
   "cell_type": "markdown",
   ...
   "outputs": [
    {
     ...
     "output_type": "stream",
     "text": [
      "🤖 Reply: This message seems related to company ID AppleSupport\n"
     ]
    }
   ],
   "source": [
    ...
    "    return f\"🤖 Reply: This message seems related to company ID {prediction}\"\n",
    "    # Example\n",
  ...
  },
  {
   ...
   "source": [
    ...
    "\n",
    "print(\"✅ Model and vectorizer saved successfully!\")# 💾 Step 9: Save model and vectorizer\n",
    "import joblib\n",
    "\n",
    "joblib.dump(model, \"chatbot_model.pkl\")\n",
    "\n",
